...
<header id="header" class="header clearfix" role="banner">
  ...
  <div class="inner-header container max-container">
    ...
    <h1><a data-nav="home" href="/ometa/secureIndex.action">Data Processing and Coordinating Center</a></h1>

    <div class="top-links clearfix">
      <div class="pull-right">
        <div class="user-info">
          <button style="display:none" id="userNameDropdown" class="btn dropdown-toggle" type="button" data-toggle="dropdown" style="color:white;background:transparent;padding:0 !important;"><span class="glyphicon glyphicon-user" style="margin-right:5px;background-color:#C2C2C2;padding:3px"></span><div class="HeaderLink" id="currUserName" style="display:inline-block"></div> <span class="caret"></span></button>
          <ul class="dropdown-menu" role="menu" aria-labelledby="userNameDropdown" style="top:auto;left:auto;right:13px;">
            <li><a href="accountInformation.action">Account Information</a></li>
            <li><a href="logout.action">Log Out</a></li>
          </ul>
        </div>
        <div class="noauthuser"><a href="secureIndex.action">DPCC Portal Login</a></div>
      </div>
    </div>
