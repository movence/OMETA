              ...
              <div id="mainContent">
                <div id="statusTableDiv">
                  <div id="tableTop">
                    <table>
                      <tr class="gappedTr">
                        <td align="right"><small class="text-danger">*</small>User ID </td>
                      ...
                      <tr class="gappedTr">
                        <td align="right"><small class="text-danger">*</small>Password </td>
                        <td style="padding-left:7px;"><s:password id="_password" name="actor.password" size="35px"/></td>
                        <!-- <td style="padding-left:7px;"><strong>User ID must match your UNIX ID.</strong></td> -->
                      </tr>
                      <tr class="gappedTr">
                        <td align="right"><small class="text-danger">*</small>Confirm Password </td>
                        <td style="padding-left:7px;"><s:password id="_passVerify" name="passVerify" size="35px"/></td>
                        <!-- <td style="padding-left:7px;"><strong>User ID must match your UNIX ID.</strong></td> -->
                      </tr>
                      <tr class="gappedTr">
                        <td align="right"><small class="text-danger">*</small>First Name </td>
                      ...
                      <tr class="gappedTr">
                        <td align="right"><small class="text-danger">*</small>Last Name </td>
                        <td style="padding-left:7px;"><s:textfield id="_lastName" name="actor.lastName" size="35px"/></td>
                      </tr>
                      <tr class="gappedTr">
                        <td align="right"><small class="text-danger">*</small>Email </td>
